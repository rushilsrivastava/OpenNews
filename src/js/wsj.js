...
document.arrive('#article_body > script[type="text/javascript"]:nth-child(23)', function() {
	console.log("found")
	let data = JSON.parse(this.innerHTML.replace("var utag_data =", '').replace(/ /g, '').replace(/;/g, ''));
	data["page_access"] = "free";
	data["cx_shield"] = {"campaign":2000,"placement":"cx-articlecover", "tag":"default", "type":"free"};
